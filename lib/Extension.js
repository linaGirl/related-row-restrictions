!function() {
    ...
    module.exports = new Class({
        ...
        /**
         * apply restirciotns on tall queries and all of the chil queries
         */
        ...
        , applyRestrictions: function(resource, restrictions, isGlobal) {
            ...
            restrictions.forEach(function(restriction) {
                ...
                if (!isGlobal || (isGlobal && targetQueryBuilder && targetQueryBuilder.hasColumn(restriction.column))) {
                    ...
                    if (!isGlobal && (!targetQueryBuilder || !targetQueryBuilder.hasColumn(restriction.column))) throw new Error('Failed to apply the restriction «'+restriction.orignalColumn+'», path or coulm not found!');
                    ...
                    if (!filters[restriction.fullPath]) filters[restriction.fullPath] = {queryBuilder: targetQueryBuilder, columns: {}};
            ...
            Object.keys(filters).forEach(function(fullPath) {
                ...
                // apply filters
                entity.queryBuilder.filter(ORMFilter);
            }.bind(this)); 
        }
        ...
        , getQueryBuilderByPath: function(path, queryBuilder) {
            ...
            if (path && path.length && queryBuilder.has(path[0])) return this.getQueryBuilderByPath(path.slice(1), queryBuilder.get(path[0]));
