!function() {
    ...
    module.exports = new Class({
        ...
        , applyRestrictionsOnQuery: function(resource) {
            ...
            this.applyRestrictions(resource, rootResource.rowRestrictions.get(resource.name, 'query'));

            // apply global restrictions
            this.applyRestrictions(resource, rootResource.rowRestrictions.getGlobal('query'), true);
        }
